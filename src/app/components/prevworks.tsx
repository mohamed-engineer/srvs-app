...
export default function PrevWorksPage() {
  ...
  return (
    <>
      <section id="prevworks" className="py-24 px-6 bg-gray-900 text-white min-h-screen">
                ...
                {project.category === "website" && project.url && (
                  <div className="mt-15 text-center">
                    <a
                      ...
                      className="inline-block px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-full transition"
                    >
                      زيارة الموقع
                    </a>
                  </div>
